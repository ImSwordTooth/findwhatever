...
export const History = () => {
	...
	return (
		<div>
			<div className="areaTitle mt-[30px]">历史记录</div>
			...
			<div>历史记录会在面板<span style={{ color:'#ff4d4f' }}>关闭</span>时更新，记入关闭时的查找词，最多记录 50 条。</div>
			<div className="setting-row">
				<div>历史记录打开方式</div>
				<Radio.Group value={setting.openHistoryMode} onChange={e  => updateSetting('openHistoryMode', e.target.value)}>
					<Radio value={'hover'}>鼠标移入</Radio>
					<Radio value={'click'}>鼠标点击</Radio>
				</Radio.Group>
			</div>
		</div>
	)
