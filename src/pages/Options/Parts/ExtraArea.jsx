...
export const ExtraArea = () => {
	...
	return (
			<div>
				<div className="areaTitle mt-[30px]">{t('右上角功能区')}</div>
				<div>
					...
					<div className="mt-[6px]">
						...
						<div>{t('控制面板的透明度，防止遮盖背后的元素。')}</div>
						<div>{t('鼠标悬浮时暂时透明，离开时恢复；也可以点击该图标，使面板固定透明。')}</div>
