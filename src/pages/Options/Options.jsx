...
export const Options = () => {
	...
	return (
		<div className="flex p-[40px] select-none">
			...
			<div className="flex-1">
				...
				<div className="w-[400px]">
					...
					<div className="rounded-xl overflow-hidden">
						...
						<div className="setting-row">
							<div>下划线是否和 search-results 一致</div>
				...
				<div className="flex items-center w-[400px] mt-[40px]">
					...
					>
						<Button className="w-[120px] mr-[12px]">重置</Button>
					</Popconfirm>
					<Button className="flex-1" type="primary" onClick={save}>保存</Button>
				</div>
				<div className="mt-2 text-[#cccccc]">* 保存后需刷新旧页面</div>
			</div>
