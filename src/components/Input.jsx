		...
		return (
			<>
				<input
					type={type}
					className={cn(
						`flex h-[32px] w-full border-none bg-[#f1f1f1] dark:bg-zinc-800 text-black dark:text-white rounded-md py-1 pl-8 pr-3 text-xs file:border-0 file:bg-transparent
